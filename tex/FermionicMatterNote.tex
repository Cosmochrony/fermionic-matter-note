  ...
  \section{Status of Results}
    ...
    \subsection{Further structural results (unconditional)}
      ...
      \begin{enumerate}
        ...
        including the zero-mode subcase; the transverse branch determines the split via the electric genus of the
        chiral polarisation~\cite{Beau2026bim}, the Schur-null branch is marginal.
      \end{enumerate}
