...
interpretation of the admissible fibre after geometric complexification.
  ...
  \section{Open Deliverables}
    ...
    What remains open is the amplitude $|u|$ (this A4 matching) and the Yukawa sector downstream of $u$.
    The amplitude is reduced in the A4 companion to the sign of the cubic backreaction
    $\mathcal P\cdot\mathcal R_\chi$ and to the boundary-versus-interior selection of the Born--Infeld
    saturation problem.
