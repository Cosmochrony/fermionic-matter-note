...
interpretation of the admissible fibre after geometric complexification.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Q14: Fermionic matter and chirality from projective Dirac admissibility}
      ...
      remains $J_\Pi$-equivariant and gives $u_{\mathrm{fin}}=0$.
      ...
      obstruct the $V-A$ selection.
      The remaining amplitude is fixed at A4 by matching the discrete chiral-frontier normalisation
      $\mathcal N_A$ with the Lorentzian Born--Infeld curvature $\mu_\chi^2=\partial_s^2\mathcal B(0)$,
      neither ingredient reducing to the other (companion oriented-frontier and Schur-complement notes).
  ...
  \section{Status of Results}
    ...
    \subsection{Open problems}
      ...
      \begin{enumerate}
        ...
        $\Epi=-M^{\dagger}M$ with $M=(1-P)D\,\Pi_S^{*}$; what is not yet constructed is its explicit
  ...
  \section{Open Deliverables}
    ...
    The structural form of $\Epi$ is now fixed as the Schur complement of the eliminated spinorial block;
    ...
    reflection $R_b=\mathrm{FT}^2$ is blind to chirality ($[\gamma_5,R_b]=0$).
