...
\begin{document}
  ...
  \begin{abstract}
    ...
    Open deliverables are the explicit form of $\Epi$ and the Yukawa sector.
  \end{abstract}
...
interpretation of the admissible fibre after geometric complexification.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Q14: Fermionic matter and chirality from projective Dirac admissibility}
      ...
      \textit{Dynamic generation lifting} (qualitative; diagnostic model).
      ...
      rotation.
      In a diagnostic model of the Q11 cascade generator $\partial_\tau$, the $J_\Pi$-odd
      projection carries a non-zero $J_3$ component ($\alpha \neq 0$), whose sign reverses under
      cascade reversal.
      The qualitative mechanism of the inter-generation splitting is thereby fixed; its amplitude is
      deferred to the cascade normalisation, and generation mixing requires the complex metaplectic
      phase.
  ...
  \section{Status of Results}
    ...
    \subsection{Open problems}
      ...
      \begin{enumerate}
        ...
        A qualitative mechanism for the inter-generation splitting is identified in Q14 \S6;
        without the explicit $\Epi$, however, its amplitude, the three-generation mass spectrum,
        and the Yukawa sector cannot be derived.
  ...
  \section{Open Deliverables}
    ...
    The qualitative segment of this deliverable is closed in Q14 \S6: the inter-generation
    splitting is statically obstructed, lives in a two-dimensional $J_\Pi$-odd lift sector, and is
    carried by the oriented cascade generator.
    What remains is quantitative: the cascade normalisation $\mathcal{N}_{\mathrm{casc}}$ fixing the
    splitting amplitude $\varepsilon = \mathcal{N}_{\mathrm{casc}}\,|\alpha|$ (to be derived from
    $c_\chi \to \delta_{\mathrm{pair}} \to \beta^*$, not fitted), the integral normalisation of
  ...
  \section{Conclusion}
    ...
    A qualitative mechanism for the inter-generation splitting is now identified (Q14 \S6: static
    obstruction, oriented $J_\Pi$-odd lift, non-zero cascade $J_3$ projection).
    The remaining open components are the explicit construction of $\Epi$, the amplitude of the
    splitting (the cascade normalisation), and the derivation of the Yukawa sector and mass
    spectrum.
