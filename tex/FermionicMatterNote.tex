...
interpretation of the admissible fibre after geometric complexification.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Arithmetic orthogonality of the ADE gate: the conditional status of
      ...
      The intrinsic depth carrier remains open in a more constrained form, the only positive route left being a
      decaying capacity-controlled per-level profile $\sigma_{\lambda_g}(n)$ transported onto the cascade, deferred
      to a later front.
