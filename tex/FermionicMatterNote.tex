...
interpretation of the admissible fibre after geometric complexification.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Arithmetic orthogonality of the ADE gate: the conditional status of
      ...
      The negative theorem --- that A1--A4 and ENI Corollary~6 do not supply the Galois-spin action --- is proved
      modulo a type-rigidity lemma on the recursive non-injectivity tower, closed for the base fibre and open for the
      recursive strata.
