...
interpretation of the admissible fibre after geometric complexification.
  ...
  \section{Conclusion}
    ...
    The remaining open components are the explicit Lorentzian $\Epi$; the split value, which is dictionary-bound and whose
    first-principles derivation is upstream and structural (the ADE case selection and level-to-generation map, the
    cascade exponent $\beta$, and the transfer constant $N_{\mathrm{casc}}$); and the derivation of the Yukawa sector and
    mass spectrum.
